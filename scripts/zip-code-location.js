...
$(document).ready(function(){
    ...
    $("#search").click(function(){
        ...
        if(!zip || !code)
            return;
        $.getJSON("https://cors-anywhere.herokuapp.com/http://api.zippopotam.us/" + code + "/" + zip, function(res){
    ...
    $(document).click(function(event){
        ...
        if(d.length === 3){
            ...
            if(valid && zip){
                $.getJSON("https://cors-anywhere.herokuapp.com/http://api.zippopotam.us/" + country.code + "/" + zip, function(res){
                    displayPlaces(res.places);
                    setMap(res.places);
                });
            }
